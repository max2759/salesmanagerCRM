...
public class ConnectionFrontValidator implements Validator {
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        //ici verifier que l'utilisateur et le mdp correspondent
...
/*
    ...
    private String getMessageError() {
        return JsfUtils.returnMessage(locale, "connection.error");
    }
